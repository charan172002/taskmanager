...
class SignUp extends React.Component {
    ...
    constructor(props) {
        ...
        this.handleChange_LoginUp = this.handleChange_LoginUp.bind(this);
    }
    
    
    handleChange_LoginUp(event) {

        this.setState({ loginup: true });
    }
        ...
        return (
            <>
                ...
                <button style={{
                    ...
                    "left": "83%",
                    "z-index": "1"
                }} id="sub" type="button" name="submit" className="save" onClick={this.handleChange_LoginUp}>Login</button>
