...
let base_url = 'https://taskmanagerserver.vercel.app'
...
let nw = { "name": "vi", "message": '[0, 1, 2, 3]' };
...
export async function ClientLogin(emailId, password) {
    ...
    if (temp['status'] === "accepted") {
        ...
        localStorage.setItem("instanceKey", temp['instanceKey']);
        localStorage.setItem("clientid", temp['clientid']);
    }
...
export async function ClientList() {
    ...
    const response = await fetch(url_with_email + `/clientlist`, {
        method: 'POST',
        headers: {
...
export async function CreateDirectTask(param) {

    const response = await fetch(url_with_email + `/createdirecttask`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'instanceKey': localStorage.getItem('instanceKey')
...
export async function GetDirectTaskList(param) {

    const response = await fetch(url_with_email + `/clientdirecttaskids`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'instanceKey': localStorage.getItem('instanceKey')
...
export async function GetTaskDetails(param) {

    const response = await fetch(url_with_email + `/gettaskdetails`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'instanceKey': localStorage.getItem('instanceKey')
